<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'transport' ? 'active' : '' }}"
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'transport ititneraires' ? 'active' : '' }}"
                    href="{{ route('transport_itineraires.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Transport itineraire</span>
                </a>
            </li>
...
<script>document.querySelector('.dropdown-btn').addEventListener('click', function() {
    ...
    this.querySelector('.dropdown-icon').classList.toggle('rotate');
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'reclamations.index' ? 'active' : '' }}"
                    href="{{ route('reclamations.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center {{ in_array(request()->route()->getName(), ['reclamations.index']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
