<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
      <a class="nav-link {{ Route::currentRouteName() == 'transport.index' ? 'active' : '' }}"
        href="{{ route('transport.index') }}">
        <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-car ps-2 pe-2 text-center
            {{ in_array(request()->route()->getName(), ['transport.index', 'transport.show', 'transport.edit']) ? 'text-white' : 'text-dark' }}"></i>
        </div>
        <span class="nav-link-text ms-1">Transports</span>
       </a>
        </li>
